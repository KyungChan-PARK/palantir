...
class ObjectSummary(BaseModel):
    ...
    insights: List[str] = Field(..., description="Insights derived from the object data")
    suggestions: List[str] = Field(..., description="Suggestions for actions or improvements")
...
class RelationshipInsight(BaseModel):
    ...
    recommendations: List[str] = Field(..., description="Recommendations based on the insight")
...
class ObjectProcessor:
    ...
    def _create_object_prompt(self, obj_type: str) -> str:
        ...
        return prompts.get(obj_type, "Analyze this object and provide key points, insights, and suggestions.")
    ...
    async def analyze_relationship(
        ...
        """
        prompt = ChatPromptTemplate.from_messages([
            ("system", """Analyze the relationship between these objects and provide:
...
class DataEnricher:
    ...
    async def generate_description(
        ...
        """
        prompt = ChatPromptTemplate.from_messages([
            ("system", "Generate a clear, concise description of this object in natural language."),
    ...
    async def suggest_tags(
        ...
        """
        prompt = ChatPromptTemplate.from_messages([
            ("system", """Suggest 3-5 relevant tags for this object.
