...
class ReviewerAgent(BaseAgent):
    ...
    def process(self, dev_results: List[Dict[str, str]], state: dict = None) -> List[Dict[str, str]]:
        """개발 결과를 리뷰"""
        review_results = []
...
class SelfImprovementAgent(BaseAgent):
    ...
    def process(self, review_results: List[Dict[str, str]], state: dict = None) -> Dict[str, Any]:
        """리뷰 결과를 바탕으로 코드 개선"""
