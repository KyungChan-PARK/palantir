...
# 사용자 관련 메트릭 추가
user_signup_total = Counter("user_signup_total", "신규 가입자 수")
user_active_total = Gauge("user_active_total", "활성 사용자 수")
user_auth_success_total = Counter("user_auth_success_total", "인증 성공 횟수")
user_auth_fail_total = Counter("user_auth_fail_total", "인증 실패 횟수")
...
def setup_monitoring(app):
    ...
    async def track_requests(request, call_next):
        ...
        BUSINESS_METRICS["request_duration"].labels(endpoint=request.url.path).observe(
            duration
        )
