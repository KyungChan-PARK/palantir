...
def test_rate_limit_for_tier():
    assert policy_guard.rate_limit_for_tier("admin") == "100/minute"
    assert policy_guard.rate_limit_for_tier("pro") == "30/minute"
    assert policy_guard.rate_limit_for_tier("free") == "5/minute"
    assert policy_guard.rate_limit_for_tier("other") == "5/minute"
